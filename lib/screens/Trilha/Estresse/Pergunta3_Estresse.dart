// lib/screens/Trilha/Estresse/Pergunta3_Estresse.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:mente_ifc/core/routes.dart';

class Pergunta3EstresseScreen extends StatelessWidget {
  const Pergunta3EstresseScreen({super.key});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('O estresse já tá afetando meu corpo 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP4),
                            const _EmotionItem('Só insônia mesmo, acho que de ansiedade 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP4),
                            const _EmotionItem('Fora cansaço, não tenho sintomas físicos 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP4),
                            const _EmotionItem('Fico tenso às vezes quando me irrito 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP4),
                            const _EmotionItem('Não, só passo mal quando estou apavorado 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP4),
                            const _EmotionItem('Não, só fico triste mesmo, nada físico 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP4),
                          ];
