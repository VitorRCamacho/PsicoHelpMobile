// lib/screens/Trilha/Estresse/Pergunta2_Estresse.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:mente_ifc/core/routes.dart';

class Pergunta2EstresseScreen extends StatelessWidget {
  const Pergunta2EstresseScreen({super.key});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const SizedBox(height: _gapXl),
                        ...
                        items: () {
                          final items = [
                            const _EmotionItem('Falta hora no dia pra tanta coisa 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP3),
                            const _EmotionItem('Dou conta sim, só fico muito ansioso 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP3),
                            const _EmotionItem('Tempo até tenho, falta é disposição 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP3),
                            const _EmotionItem('Tempo não falta; o que falta é paciência 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP3),
                            const _EmotionItem('Não, tempo eu tenho; o medo que atrapalha 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP3),
                            const _EmotionItem('Tenho tempo, falta vontade pra aproveitar 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP3),
                          ];
