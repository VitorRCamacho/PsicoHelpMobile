...
class Pergunta2TristezaScreen extends StatelessWidget {
  const Pergunta2TristezaScreen({super.key});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Sinto que nada mais vai melhorar 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP3),
                            const _EmotionItem('Sem esperança não, só preocupado mesmo 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP3),
                            const _EmotionItem('Sem esperança não, só irritado mesmo 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP3),
                            const _EmotionItem('Sem esperança não, só com receios 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP3),
                            const _EmotionItem('Sem esperança não, só sobrecarregado mesmo 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP3),
                            const _EmotionItem('Sem esperança não, só meio sozinho 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP3),
                          ];
