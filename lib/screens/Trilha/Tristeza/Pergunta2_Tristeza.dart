                ...
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: const [
                          _EmotionItem('Triste 🥺', [], Routes.tristezaP3),
                          _EmotionItem('Ansioso(a) 😔', [], Routes.ansiedadeP3),
                          _EmotionItem('Com raiva 😤', [], Routes.raivaP3),
                          _EmotionItem('Com medo 😟', [], Routes.medoP3),
                          _EmotionItem('Estressado(a) 😵‍💫', [], Routes.estresseP3),
                          _EmotionItem('Sozinho(a) 💛', [], Routes.solidaoP3),
                        ],
                      ),
                      const SizedBox(height: _gapXl),
                      Center(
