...
class Pergunta4RaivaScreen extends StatelessWidget {
  const Pergunta4RaivaScreen({super.key});
                ...
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const SizedBox(height: _gapMd),
                      Text(
                        'Com que frequência você sente uma raiva tão intensa que gostaria de gritar ou quebrar alguma coisa?',
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Direto dá vontade de quebrar tudo 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP5),
