...
class Pergunta1RaivaScreen extends StatelessWidget {
  const Pergunta1RaivaScreen({super.key});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Ando irritado com quase tudo 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP2),
                            const _EmotionItem('Não irritado, mas sim muito nervoso 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP2),
                            const _EmotionItem('Irritado não, estou desanimado ultimamente 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP2),
                            const _EmotionItem('Irritado não, só receoso e preocupado 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP2),
                            const _EmotionItem('Irritado não, só exausto e pressionado 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP2),
                            const _EmotionItem('Irritado não, só me sentindo sozinho 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP2),
                          ];
