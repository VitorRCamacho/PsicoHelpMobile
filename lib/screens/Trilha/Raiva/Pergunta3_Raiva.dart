                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Faço bobagem de cabeça quente 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP4),
                            const _EmotionItem('Não costumo explodir, fico mais nervoso 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP4),
                            const _EmotionItem('Não, quando fico mal eu choro 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP4),
                            const _EmotionItem('Não, quando fico com medo travo 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP4),
                            const _EmotionItem('Quando estou no limite, falo sem pensar 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP4),
                            const _EmotionItem('Não explodo, só acabo guardando tudo 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP4),
                          ];
