// lib/screens/Trilha/Medo/Pergunta4_Medo.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:mente_ifc/core/routes.dart';

class Pergunta4MedoScreen extends StatelessWidget {
  const Pergunta4MedoScreen({super.key});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Meu coração dispara e fico tremendo 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP5),
                            const _EmotionItem('Coração só dispara quando estou ansioso 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP5),
                            const _EmotionItem('Levo susto normal, nada de sintoma forte 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP5),
                            const _EmotionItem('Levo um susto, mas não passo mal 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP5),
                            const _EmotionItem('Se tomo um susto forte, coração acelera 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP5),
                            const _EmotionItem('Levo susto e coração acelera, normal 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP5),
                          ];
