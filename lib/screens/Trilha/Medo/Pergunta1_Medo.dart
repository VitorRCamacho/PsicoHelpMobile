// lib/screens/Trilha/Medo/Pergunta1_Medo.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:mente_ifc/core/routes.dart';

class Pergunta1MedoScreen extends StatelessWidget {
  const Pergunta1MedoScreen({super.key});
                ...
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const SizedBox(height: _gapMd),
                      Text(
                        'Você está sentindo medo de algo específico ou uma sensação geral de insegurança?',
                      ...
                      _EmotionGrid(
                        items: () {
                          final items = [
                            const _EmotionItem('Sinto um medo constante sem explicação 😨', [Color(0xFFA78BFA), Color(0xFF8B6CFF)], Routes.medoP2),
                            const _EmotionItem('Não é medo; me cobro demais 😟', [Color(0xFF31D0C6), Color(0xFF1FBBC1)], Routes.ansiedadeP2),
                            const _EmotionItem('Não, só me sinto desanimado mesmo 😞', [Color(0xFF6EA8FF), Color(0xFF4F83FF)], Routes.tristezaP2),
                            const _EmotionItem('Não sinto medo, só irritação mesmo 😠', [Color(0xFFFF8CA1), Color(0xFFFF6D8A)], Routes.raivaP2),
                            const _EmotionItem('Não, só preocupação com responsabilidades reais 😫', [Color(0xFFFFB74D), Color(0xFFFFA726)], Routes.estresseP2),
                            const _EmotionItem('Não, sinto mais solidão que medo 😔', [Color(0xFFFF8FB3), Color(0xFFFF79A8)], Routes.solidaoP2),
                          ];
